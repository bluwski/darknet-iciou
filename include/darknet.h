...
LIB_API void set_track_id(detection *new_dets, int new_dets_num, float thresh, float sim_thresh, float track_fiou_norm, int deque_size, int dets_for_track, int dets_for_show);
