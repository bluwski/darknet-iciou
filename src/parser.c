...
layer parse_yolo(list *options, size_params params)
{
    ...
    else if (strcmp(iou_loss, "fiou") == 0) l.iou_loss = FIOU;
    else l.iou_loss = IOU;
    ...
    else if (strcmp(iou_thresh_kind_str, "fiou") == 0) l.iou_thresh_kind = FIOU;
    else {
    ...
    l.track_fiou_norm = option_find_float_quiet(options, "track_fiou_norm", 0.01);
