    ...
    int benchmark, int benchmark_layers)
{
    ...
    while(1){
        ++count;
        {
            ...
            if (l.embedding_size) set_track_id(local_dets, local_nboxes, demo_thresh, l.sim_thresh, l.track_fiou_norm, l.track_history_size, l.dets_for_track, l.dets_for_show);
